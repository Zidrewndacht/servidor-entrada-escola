...
class Auth extends ShieldAuth
{
     ...
     */
    public bool $allowRegistration = false;     //apenas criação de contas via painel administrativo
     ...
     * has been set up.
     */
    public bool $allowMagicLinkLogins = true;   //como ativar uso disso como método de criação de primeira senha?
     ...
     */
    public int $magicLinkLifetime = 2 * DAY;        //dois dias para criar senha
    ...
    public array $sessionConfig = [
        ...
        'rememberLength'     => 150 * DAY,  //aprox. um login por semestre
    ];
     ...
     */
    public function loginRedirect(): string     //alterado para executar redirecionamentos.
    {          
        $session = session(); 
        $user = auth()->user();
